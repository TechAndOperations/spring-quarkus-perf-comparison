...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
  ...
  # NOTE: nestjs11-node and axum08-rust are deliberately absent from DEFAULT_RUNTIMES. Adding a
  # new runtime to the defaults would silently change the composition of every existing
  # full-suite run.
